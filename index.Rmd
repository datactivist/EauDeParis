...
- des .red[obligations légales] : la loi pour une République numérique, et la loi de transition énergétique pour la croissance verte principalement
...
[![](./img/data_sispea_edp_2015.png)](https://www.services.eaufrance.fr/donnees/departement/75/2015)
...
### Eau de Paris peut aussi contribuer à cet .red[édifice commun]

---
## Elargir les données de consommations disponibles ?

S'inspirer des données de l'énergie pour proposer une vision similaire de l'eau

![](./img/data_ore_energie.png)

---
## Expérimenter sur l'eau non potable ?

Le double réseau parisien offre l'opportunité d'expérimenter sans enjeu de sensibilité

![](./img/data_edp_enp.png)
